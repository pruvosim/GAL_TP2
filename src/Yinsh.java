...
public class Yinsh {
    ...
    public void putRing(Coordinates coor, Color Color) throws Exception
    {
        char col = coor.colonne;
        int line = coor.ligne;
    ...
    public void putMarker(Coordinates coor, Color Color) throws Exception
    {
        char col = coor.colonne;
        int line = coor.ligne;
    ...
    public void moveRing(Coordinates depart, Coordinates arrivee, Color color) throws Exception
    {

        char colDepart = depart.colonne;
        int lineDepart = depart.ligne;
        char colArrivee = arrivee.colonne;
        int lineArrivee = arrivee.ligne;
        ...
        if(m_plateau[columnDepart][lineDepart] == color)
        {
        ...
        {
            System.out.println("La couleur spécifiée en paramètre et celle de l'anneau sont différentes !");
        }


    }

    public void removeRow(Coordinates depart, Coordinates arrivee, Color color) throws Exception
    {
        char colDepart = depart.colonne;
        int lineDepart = depart.ligne;
        char colArrivee = arrivee.colonne;
    ...
    public void removeRing(Coordinates coor, Color color)
    {
        char col = coor.colonne;
        int line = coor.ligne;
